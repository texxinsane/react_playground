...
class __TwigTemplate_ef659f90a4c8627a80804204f82345f4fcff57528bc21a41923c8bdcefebc9b0 extends \Twig\Template
{
    private $source;
...
";
    ...
    : \$view['form']->humanize(\$name); } ?>
<button type=\"<?php echo isset(\$type) ? \$view->escape(\$type) : 'button' ?>\" <?php echo \$view['form']->block(\$form, 'button_attributes') ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$label, [], \$translation_domain) : \$label) ?></button>
", "@Framework/Form/button_widget.html.php", "/var/www/react_playground/vendor/symfony/framework-bundle/Resources/views/Form/button_widget.html.php");
    }
}
