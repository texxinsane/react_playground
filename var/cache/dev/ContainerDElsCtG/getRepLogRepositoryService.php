...
// Returns the private 'App\Repository\RepLogRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/RepLogRepository.php';

return $this->privates['App\\Repository\\RepLogRepository'] = new \App\Repository\RepLogRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
